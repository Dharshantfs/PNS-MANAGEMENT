  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-brand-950/75 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white text-slate-900 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl border border-brand-100">
        ...
        <div className="bg-brand-700 px-6 py-3.5 flex items-center justify-between text-white shadow-sm print:hidden">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-start justify-between border-b border-slate-200 pb-5">
            ...
            <div className="text-right">
              ...
              <p className="text-xs font-mono font-bold text-brand-900 mt-1.5">{payment.receiptNumber}</p>
          ...
          <div className="grid grid-cols-2 gap-4 bg-brand-50/50 p-4 rounded-2xl text-xs border border-brand-200">
            ...
            <div className="text-right">
              ...
              <p className="text-brand-800 font-bold">Mode: {payment.paymentMode}</p>
          ...
          <div className="border border-slate-200 rounded-2xl overflow-hidden text-xs">
            ...
            <div className="bg-brand-50 px-4 py-3 border-t border-brand-200 flex justify-between items-center">
              <span className="font-extrabold text-brand-950">Total Amount Paid</span>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-slate-200 text-xs">
            <div className="flex items-center space-x-2.5">
              <div className="w-12 h-12 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-center">
                <QrCode className="w-8 h-8 text-brand-900" />
              </div>
              <div>
