...
export const Navbar: React.FC<NavbarProps> = () => {
  ...
  return (
    <header id="app-header" className="sticky top-0 z-40 bg-brand-700 border-b border-brand-800 text-white shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-2xl bg-white text-brand-700 flex items-center justify-center shadow-md font-black shrink-0">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[11px] px-2.5 py-0.5 rounded-full bg-brand-800 border border-brand-600 text-brand-100 font-semibold">
                  {settings.totalFloors} Floors • {stats.totalBeds} Beds
                </span>
              </div>
              <p className="text-xs text-brand-200">Hostel & Digital Tenant Management Portal</p>
            </div>
          </div>
